...
class InstanceWrapper {
    ...
    isDependencyTreeDurable(lookupRegistry = []) {
        ...
        const isTreeNonDurable = this.introspectDepsAttribute((collection, registry) => collection.every((item) => !item.isDependencyTreeDurable(registry)), lookupRegistry);
    ...
    introspectDepsAttribute(callback, lookupRegistry = []) {
        ...
        let introspectionResult = (dependencies && callback(dependencies, lookupRegistry)) || !dependencies;
    ...
    isDependencyTreeStatic(lookupRegistry = []) {
        ...
        this.isTreeStatic = this.introspectDepsAttribute((collection, registry) => collection.every((item) => item.isDependencyTreeStatic(registry)), lookupRegistry);
