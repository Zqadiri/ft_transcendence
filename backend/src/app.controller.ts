...
export class AppController {
	...
	async getAuthPage(@Res() response: Response){
		...
		return { 
			// url: 'https://api.intra.42.fr/oauth/authorize?client_id=49a4b98742acf9bf17d4d7299520cad7fc235f437be130d267a93f39a1444185&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fauth%2Flogin&response_type=code' dyal zineb
			// url: 'https://api.intra.42.fr/oauth/authorize?client_id=92e62198e4bd75e7df8ab207bde4e884ad61f6c05cae826d6d0e18e98327391b&redirect_uri=http%3A%2F%2F10.11.13.3%3A3000%2Fauth%2Flogin&response_type=code' dyal sesco
